...
const rows = [
  createInternData('Nguyen Dinh Hoang', 'hoangnd@viettel.com.vn', 'UET-VNU'),
  createInternData('Nguyen Dinh Minh', 'hoangnd@viettel.com.vn', 'UET-VNU'),
  createInternData('Nguyen Dinh Binh', 'hoangnd@viettel.com.vn', 'UET-VNU'),
  createInternData('Nguyen Dinh Minh Quang', 'hoangnd@viettel.com.vn', 'UET-VNU'),
  createInternData('Nguyen Thi Diep', 'hoangnd@viettel.com.vn', 'UET-VNU')
];
...
interface EnhancedTableProps {
  numSelected: number;
  onRequestSort: (event: React.MouseEvent<unknown>, newOrderBy: keyof Intern) => void;
