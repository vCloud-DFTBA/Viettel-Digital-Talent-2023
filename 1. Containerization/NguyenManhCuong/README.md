...
# Table of contents
---
- [**I. Containerization** ](#1-containerization)
  - [**1. Overview**  ](#11-overview)
  - [**2. Containerization vs Virtualization** ](#12-containerization-vs-virtualization)
  - [**3. Benefits of Containerization**](#13-benefits-of-containerization)
  - [**4. Linux Technologies Fundamental to Containers**](#14-linux-technologies-fundamental-to-containers)
- [**II. Docker**](#2-docker)
  - [**1. Docker Architecture**](#21-docker-architecture)
  - [**2. Docker Objects**](#22-docker-objects)
  - [**3. Dockerfile**](#23-dockerfile)
  - [**4. Docker Compose**](#24-docker-compose)
  - [**5. Docker Image Optimization**](#25-docker-image-optimization)
- [**III. Homework**](#3-homework)
  - [**1. Requirements**](#31-requirements)
  - [**2. Explaination**](#32-explaination)
  - [**3. Result**](#33-result)
