from model import (Student, UpdateStudent, ResponseModel, ErrorResponseModel,)
from database import (fetch_all_students, fetch_one_student, create_student, update_student, remove_student,)
import json
