...
class Intern:
    def __init__(self, name, year_of_birth, university):
        self.name = name
        self.university = university
        self.year_of_birth = year_of_birth
        unicode_name = unidecode(self.name)
        self.email = (
            unicode_name.split(" ")[-1].lower()
            + unicode_name.split(" ")[0][0].lower()
            + unicode_name.split(" ")[1][0].lower()
            + "@"
            + "is.viettel.com.vn"
        )
